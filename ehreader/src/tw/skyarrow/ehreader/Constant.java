...
public class Constant {
    public static final String API_URL = "https://e-hentai.nhent.ai/api.php";
    public static final String API_URL_EX = "https://exhentai.org/api.php";

    public static final String BASE_URL = "https://e-hentai.nhent.ai";
    public static final String BASE_URL_EX = "https://exhentai.org";

    public static final String GALLERY_URL = "https://e-hentai.nhent.ai/g/%d/%s";
    public static final String GALLERY_URL_EX = "https://exhentai.org/g/%d/%s";

    public static final String PHOTO_URL = "https://e-hentai.nhent.ai/s/%s/%d-%d";
    ...
    public static final String HATHDL_URL = "https://e-hentai.nhent.ai/hathdler.php?gid=%d&t=%s";
    ...
    public static final String AUTHOR_PAGE = "https://facebook.com/composer.json";
    public static final String HOMEPAGE = "https://e-hentai.nhent.ai";
